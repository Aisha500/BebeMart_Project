...
## 🔗 Live Deployment
**View the live site here:** [https://bebe-mart-project.vercel.app/](https://bebe-mart-project.vercel.app/)
...
* **The item is free:** Only a small platform maintenance fee of **500 NGN** is charged to keep the service running.

* **Dignity & Community:** This system preserves the dignity of the transaction while supporting families in need.
...
Product images are hosted locally within the `/public/assets/` directory to ensure 100% uptime and independence from external API hosting.
...
git clone [https://github.com/Aisha500/BebeMart_Project.git](https://github.com/Aisha500/BebeMart_Project.git)
